...
const ThemeSwitcher = () => {
  return (
    <div className="flex mt-6 bg-white justify-center dark:bg-customDark rounded-3xl p-1">
      <button
        type="button"
        ...
        className="flex items-center h-full pr-2 dark:bg-darkPrimary rounded-3xl flex justify-center align-center p-2 w-24 h-10 transition"
      >
        {moonIcon}
      </button>
  ...
  return (
    <footer className="py-16 flex flex-col items-center">
      <div className="dark:text-white uppercase mb-3 font-bold opacity-60">
        ...
        &nbsp;&nbsp;•&nbsp;&nbsp;
        <Link
          href="https://github.com/netlify-templates/nextjs-blog-theme"
          rel="noopener noreferrer"
          target="_blank"
        >
          Theme by Bejamas
